...
def main():
    ...
    if choice == "Home":
        st.subheader("Home")
        # Image
        st.image(load_image("C:\\Users\\Ayush\\Downloads\\MetaData-App-master\\MetaData-App-master\\images\\image.png"))
        # Description
        ...
        st.sidebar.text("Created & Devloped With Tech")
        st.info("Aarkesh Sharma")
        st.image(load_image("C:\\Users\\Administrator\\Desktop\\Streamlit\\metadata_app_final\\images\\ipec image.png"))
